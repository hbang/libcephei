...
%hookf(int, sandbox_check, pid_t pid, const char *operation, enum sandbox_filter_type type, char *path) {
	// if this is a preference lookup
	if (type & SANDBOX_FILTER_PREFERENCE_DOMAIN) {
		// allow it
		return 0;
	} else {
		// else call through
