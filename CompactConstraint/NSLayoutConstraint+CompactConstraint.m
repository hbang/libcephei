...
+ (NSArray *)hb_compactConstraints:(NSArray *)relationshipStrings metrics:(NSDictionary *)metrics views:(NSDictionary *)views
{
...
+ (NSArray *)hb_compactConstraints:(NSArray *)relationshipStrings metrics:(NSDictionary *)metrics views:(NSDictionary *)views self:(id)selfView
{
    ...
    for (NSString *relationship in relationshipStrings) {
        [constraints addObject:[self hb_compactConstraint:relationship metrics:metrics views:views self:selfView]];
    }
    return [constraints copy];
}

+ (instancetype)hb_compactConstraint:(NSString *)relationship metrics:(NSDictionary *)metrics views:(NSDictionary *)views
{
