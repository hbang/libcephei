 ...
 * [CompactConstraint](https://github.com/marcoarment/CompactConstraint) library, is integrated with
 * Cephei. CompactConstraint provides an Auto Layout grammar and methods that are easier to use and
 * understand than UIKit’s built in functions for programmatically adding constraints.
 *
