...
/// The `UIStatusBarCustomItemView` class in `CepheiStatusBar` is a compatibility layer for tweaks
/// tweaks using the libstatusbar API. If libstatusbar or a fork is installed, that tweak’s
/// implementation is used, otherwise, Cephei’s implementation is used.
///
