...
///
/// The value is expected to either be an array of 3 or 4 integer RGB or RGBA color components
/// (respectively), with values between 0 and 255, or a CSS hexadecimal color code string.
///
