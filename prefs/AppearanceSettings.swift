...
public class AppearanceSettings: NSObject {
	...
	///
	/// - returns: By default, UIUserInterfaceStyleUnspecified.
	...
	///
	/// - returns: By default, UIStatusBarStyleDefault.
	...
	///
	/// - returns: By default, HBAppearanceSettingsLargeTitleStyleRootOnly.
